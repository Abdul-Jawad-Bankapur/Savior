...
public class EmergencyLocationService extends Service {
    ...
    private static final String SERVER_URL = "http://192.168.0.108:8000/api/telemetry";
                ...
                .addOnSuccessListener(location -> {
                    if (location != null) {
                        ...
                        try {
                            ...
                            payload.put(location.getLatitude());
                            payload.put(location.getLongitude());
                            payload.put(timestamp);

                            sendTelemetryData(payload.toString());
    ...
    private void sendTelemetryData(String jsonPayload) {
