...
public class EmergencyCallReceiver extends BroadcastReceiver {
    ...
    public static final String TARGET_SAVIOR_NUMBER = "7760001458"; // Example target number
    ...
    private void handleCallState(Context context, int state, String phoneNumber) {
        if (state == TelephonyManager.CALL_STATE_OFFHOOK) {
            ...
            // In a real scenario, we check if phoneNumber equals TARGET_SAVIOR_NUMBER.
